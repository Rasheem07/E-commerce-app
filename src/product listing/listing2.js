...
import { topDeals } from "../main/categorieslist";
import "./listing.css";

function Listing2({ deals }) {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      try {
        ...
        const filtered2 = topDeals.filter((cat) => cat.product === deals);
      ...
      <div className="row">
        <div className="col-lg-3 col-md-4 col-sm-12 mb-4">
          <div className="filter-sidebar">
            ...
            <select className="form-select" value={deals || "All"}>
