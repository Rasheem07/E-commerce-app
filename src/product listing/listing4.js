...
import { recommendedProducts } from "../main/categorieslist";
import "./listing.css";

function Listing3({ rec }) {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      try {
        ...
        const filtered4 = recommendedProducts.find((cat) => cat.product === rec);

        if ([filtered4]) {
          setFilteredProducts4([filtered4]);
        } else {
      ...
      <div className="row">
        <div className="col-lg-3 col-md-4 col-sm-12 mb-4">
          <div className="filter-sidebar">
            ...
            <select className="form-select" value={rec || "All"}>
